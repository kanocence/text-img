 ...
 */
export const gaussianBlur = (imgData: ImageData, radius: number = 2): ImageData => {
...
export const getTextColor = (data: ImageData, fontSize: number = 12): string[][] => {
